...
if __name__ == "__main__":
    ...
    teacher_1 = RLAgent(args.max_round, 'teacher_1', device, 3, args.algo)
    teacher_1.load('1')

    teacher_2 = RLAgent(args.max_round, 'teacher_2', device, 3, args.algo)
    teacher_2.load('2')

    teacher_3 = RLAgent(args.max_round, 'teacher_3', device, 3, args.algo)
    teacher_3.load('3')

    teacher_4 = RLAgent(args.max_round, 'teacher_4', device, 3, args.algo)
    teacher_4.load('4')
    ...
    if args.mode == "train":
        ...
        while total_timesteps < args.max_timesteps:
            ...
            if total_timesteps < 0.9 * args.max_timesteps and total_timesteps > args.start_timesteps:
                ...
                evaluation_reward_teacher_1, evaluation_round_teacher_1 = evaluate_policy(teacher_1, opponent, domain='randomDomain', eval_episodes=300, render=False)
                evaluation_reward_teacher_2, evaluation_round_teacher_2 = evaluate_policy(teacher_2, opponent, domain='randomDomain', eval_episodes=300, render=False)
                evaluation_reward_teacher_3, evaluation_round_teacher_3 = evaluate_policy(teacher_3, opponent, domain='randomDomain', eval_episodes=300, render=False)
                evaluation_reward_teacher_4, evaluation_round_teacher_4 = evaluate_policy(teacher_4, opponent, domain='randomDomain', eval_episodes=300, render=False)
                ...
                rl_agent.compute_p(mix_factor, teacher_evaluation)
        ...
        with open("mix_" + str(args.oppo_type) + "_DefensiveCharms_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_DefensiveCharms:
                f.write(str(i))
                f.write("\n")       
        with open("mix_" + str(args.oppo_type) + "_DefensiveCharms_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_Acquisition_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_Acquisition:
                f.write(str(i))
                f.write("\n")     
        with open("mix_" + str(args.oppo_type) + "_Acquisition_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_Kitchen_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_Kitchen:
                f.write(str(i))
                f.write("\n") 
        with open("mix_" + str(args.oppo_type) + "_Kitchen_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_HouseKeeping_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_HouseKeeping:
                f.write(str(i))
                f.write("\n")       
        with open("mix_" + str(args.oppo_type) + "_HouseKeeping_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_Animal_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_Animal:
                f.write(str(i))
                f.write("\n")     
        with open("mix_" + str(args.oppo_type) + "_Animal_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_Outfit_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_Outfit:
                f.write(str(i))
                f.write("\n") 
        with open("mix_" + str(args.oppo_type) + "_Outfit_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_DogChoosing_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_DogChoosing:
                f.write(str(i))
                f.write("\n")     
        with open("mix_" + str(args.oppo_type) + "_DogChoosing_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_SmartPhone_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_SmartPhone:
                f.write(str(i))
                f.write("\n")     
        with open("mix_" + str(args.oppo_type) + "_SmartPhone_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
        ...
        with open("mix_" + str(args.oppo_type) + "_Wholesaler_rewards" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
            for i in rewards_Wholesaler:
                f.write(str(i))
                f.write("\n")     
        with open("mix_" + str(args.oppo_type) + "_Wholesaler_rounds" + "_seed"  + str(args.seed) + ".txt", "w") as f:      
